...
pacman::p_load_current_gh("adletaw/captioner", 'trinker/testing', 'ramnathv/rCharts', 'trinker/plotflow', 'trinker/textshape')
...
sankey <- fg(name = "sankey1", caption = "This interactive Sankey diagram has an advantage over the often overcrowded static version in that a mouse over of the nodes or edges highlights the attached edges, allowing for \"untangling\" the over-plotting.  Additionally, edge and node counts are available as a tool-tip on demand without cluttering the plot region.")
```
...
<iframe src="p2.html" align="center" width="900" height="450" frameBorder="0"></iframe>
`r filtbar`
...
<iframe src="ganttss.html" align="center" width="1200" height="450" frameBorder="0"></iframe>
`r gantt`
